...
![](Prediction_files/figure-html/histGroup-1.png)<!-- -->

```r
histGroup(DTrainCS, "[^(fore)]arm")
```

![](Prediction_files/figure-html/histGroup-2.png)<!-- -->

```r
histGroup(DTrainCS, "dumbbell")
```

![](Prediction_files/figure-html/histGroup-3.png)<!-- -->

```r
histGroup(DTrainCS, "forearm")
```

![](Prediction_files/figure-html/histGroup-4.png)<!-- -->
